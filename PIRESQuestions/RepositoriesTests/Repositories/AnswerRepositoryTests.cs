...
namespace Repositories.Repositories.Tests
{
    ...
    public class AnswerRepositoryTests
    {
        ...
        public async Task CreateAnswerAsyncTestIdAutoIncrement()
        {
            ...
            var context = new ApplicationDbContext(builder.Options);
            context.Database.EnsureDeleted();
            Answer answer1 = new Answer { Id = 0, Horodatage = DateTime.Now, QuestionId = 12, ChoiceId = 0, AnonymousId = 0 };
        ...
        public async Task GetAllAnswerAsyncTest()
        {
            ...
            context.Answers.Add(new Answer { Id = 2, Horodatage = DateTime.Now, QuestionId = 1, ChoiceId = 2, AnonymousId = 2 });
            context.Answers.Add(new Answer { Id = 3, Horodatage = DateTime.Now, QuestionId = 2, ChoiceId = 3, AnonymousId = 3 });
            context.Answers.Add(new Answer { Id = 4, Horodatage = DateTime.Now, QuestionId = 10, ChoiceId = 4, AnonymousId = 4 });
        ...
        public async Task GetAnswerByIdAsyncTest()
        {
            ...
            context.Database.EnsureDeleted();
            context.Answers.Add(new Answer { Id = 1, Horodatage = DateTime.Now, QuestionId = 12, ChoiceId = 1, AnonymousId = 1 });
            context.Answers.Add(new Answer { Id = 2, Horodatage = DateTime.Now, QuestionId = 1, ChoiceId = 2, AnonymousId = 1 });
            context.Answers.Add(new Answer { Id = 3, Horodatage = DateTime.Now, QuestionId = 2, ChoiceId = 3, AnonymousId = 1 });
            context.Answers.Add(new Answer { Id = 4, Horodatage = DateTime.Now, QuestionId = 10, ChoiceId = 4, AnonymousId = 1 });
